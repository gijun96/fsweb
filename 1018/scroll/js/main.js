$(function(){
    ...
    $(window).scroll(function(){
        ...
        $("#value").text(sct);
        $("#item1").css({'top': top + sct / 4});
        $("#item2").css({'top': top + sct / 5, 'left': left2+sct/8});
        $("#item3").css({'top': top + sct / 7, 'left': left3+sct/6});
        $("#item4").css({'top': top + sct / 8, 'left': left4+sct/5});
        $("#item5").css({'left' :left4+sct/4, 'top': top + sct / 8});
    });
});