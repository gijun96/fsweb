...
public class PuzzleGameActionListener3 extends JFrame implements ActionListener {
	...
	public PuzzleGameActionListener3() {
		setTitle("PuzzleGame");
		setBounds(1200, 100, 400, 500);
		
//		퍼즐에 사용할 이미지를 이름을 저장한 배열을 선언한다.
		String[] puzzleName = {"뽀로로", "보노보노", "코난", "인형", "도라에몽", "미니언즈", "나루토", "숫자", "원피스", "피카츄", "곰돌이푸",
				"호랑이형님", "설현"};
		
//		InputDialog에서 퍼즐에 사용할 이미지를 선택한다.
	...
	public static void main(String[] args) {
		...
		PuzzleGameActionListener3 window = new PuzzleGameActionListener3();
