...
//	키보드로 텍스트 파일의 이름을 입력받아 텍스트 파일의 데이터를 읽어서 MemoList 클래스의 memoList ArrayList에 저장하는 메소드를 호출하는
//	메소드
...
//		텍스트 파일의 데이터를 읽어서 MemoList 클래스의 memoList ArrayList에 저장하는 메소드를 실행한다.
		memoList.fileReadMemo(filename);
		
		System.out.println(filename + ".txt 파일에 읽기완료!!!");
	}

//	키보드로 텍스트 파일의 이름을 입력받아 MemoList 클래스의 memoList ArrayList에 저장된 데이터를 텍스트 파일로 출력하는 메소드를 호출하는
//	메소드
...
//	키보드로 수정할 글번호를 입력받아 수정할 글 1건을 화면에 표시하고 비밀번호를 입력받아 memoList ArrayList에 저장된 글 1건을 수정하는 메소드를
//	실행하는 메소드
...
//	키보드로 삭제할 글번호를 입력받아 삭제할 글 1건을 화면에 표시하고 비밀번호를 입력받아 memoList ArrayList에 저장된 글 1건을 삭제하는 메소드를
//	실행하는 메소드
