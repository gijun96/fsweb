package a0925.EX.kr.koreait.score;

public class ScoreVO {

//	static으로 선언한 변수는 현재 클래스의 객체가 최초로 생성될 때 메모리에 생성되고 초기화되며 현재 클래스의 객체가 또 생성되더라도 다시 생성하지
//	않는다. => 현재 클래스로 생성한 모든 객체에서 공유해 사용한다. => 클래스의 객체를 생성하지 않고 "."을 찍어서 바로 접근할 수 있다.
