...
public class SyncronizedAreaTest {

	public static void main(String[] args) {
		
//		공유 영역으로 사용할 클래스의 객체를 선언한다.
//		ShareArea 클래스의 객체(변수)는 참조 변수로 ShareArea 클래스의 객체가 메모리에 생성된 주소를 기억한다.
...
//		공유 영역을 사용하는 두 번째 방법
//		공유 영역을 공유해서 사용할 클래스의 객체를 선언하고 setters 메소드를 사용해서 공유 영역의 주소를 넣어준다.
		CalculatorThread calculator = new CalculatorThread();
		PrintThread print = new PrintThread();
...
//		공유 영역 확인 테스트
//		calculator.shareArea.result = 100;
